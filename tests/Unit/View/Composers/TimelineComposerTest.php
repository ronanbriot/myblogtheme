...
class TimelineComposerTest extends WP_UnitTestCase
{
     ...
     */
    public function testEventsMethod()
    {
     ...
     */
    public function testEventsMethodWithPageParameter()
    {
     ...
     */
    public function testEventIconsByCategory()
    {
        $result = $this->timelineComposer->events();
     ...
     */
    public function testLoadMoreMethod()
    {
     ...
     */
    public function testLoadMoreMethodWithoutParameters()
    {
        // Réinitialiser $_POST
        $_POST = [];
     ...
     */
    public function testPaginationWithPostsPerPage()
    {
     ...
     */
    public function testPostsOrderByDate()
    {
        $result = $this->timelineComposer->events();
     ...
     */
    public function testViewsProperty()
    {
